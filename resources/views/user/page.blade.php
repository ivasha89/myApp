...
{{--        </div>--}}
{{--    @endif--}}
    <div class="d-flex bg-light rounded flex-row p-2">
            <div class="flex-column w-25 p-2">
                <figure class="figure shadow-sm rounded">
                    <img src='{{ url("/svg/".$user->id.".jpg") }}' alt="" width="255" class="figure-img rounded-circle img-thumbnail m-5">
                    <div class="lastSeen font-weight-bold text-dark figure-caption text-right p-2" id="{{ $user->lastSeen_at }}"></div>
                </figure>
